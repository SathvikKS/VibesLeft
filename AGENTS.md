...
This project is indexed by GitNexus as **Vibes Left** (47 symbols, 46 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
