...
This project is indexed by GitNexus as **Vibes Left** (458 symbols, 783 relationships, 24 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
