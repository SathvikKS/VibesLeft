...
This project is indexed by GitNexus as **Vibes Left** (542 symbols, 1011 relationships, 36 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
