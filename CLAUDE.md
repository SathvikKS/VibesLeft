...
This project is indexed by GitNexus as **Vibes Left** (154 symbols, 197 relationships, 3 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
