...
This project is indexed by GitNexus as **Vibes Left** (549 symbols, 1031 relationships, 36 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
