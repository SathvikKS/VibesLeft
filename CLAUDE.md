...
This project is indexed by GitNexus as **Vibes Left** (490 symbols, 844 relationships, 27 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
